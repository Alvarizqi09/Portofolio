      ...
      <div className="lg:w-1/2 sm:w-full h-full flex flex-col mx-5 mt-5">
        ...
        <div>
          <p className="text-xl text-justify text-gray-800 lg:mx-10 sm:mx-5">
            ...
            successfully revamping UI`s, enhancing user satisfaction. Proficient
            in graphic design tools like Canva and Corel Draw, Im dedicated to
            translating innovative ideas into user-centric designs. Eager to
            contribute to impactful projects, I stay updated with the latest
            industry trends to deliver outstanding digital solutions. Lets
            collaborate and bring creative visions to life!
          </p>
        </div>
      </div>
