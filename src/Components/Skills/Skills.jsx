      ...
      <div className="justify-center items-center w-full text-center flex flex-col lg:flex-row sm:flex-col">
        <div className="lg:w-1/2 sm:w-full h-full items-center justify-center">
          <p className="text-xl text-justify text-gray-800 mx-10">
            ...
            Draw, and Canva. With over 2 years of hands-on experience in design,
            I seamlessly merge creativity with technical acumen to deliver
            visually stunning and functionally robust web solutions. Committed
            to continuous learning and innovation, I am poised to contribute
            effectively to cutting-edge projects that demand a fusion of design
        ...
        <div className="lg:w-1/2 sm:w-full h-full flex lg:overflow-hidden items-center justify-center">
          <div className="mt-8 inline-flex w-full flex-wrap text-center items-center sm:justify-center justify-between gap-5 p-10">
            ...
            <article className="shadow-md rounded-lg overflow-hidden flex-shrink-0">
              <img src={laravel} alt="Anime" className="w-32 h-32 shadow-lg" />
            </article>
            <article className="shadow-md rounded-lg overflow-hidden flex-shrink-0">
              <img src={tailwind} alt="Anime" className="w-32 h-32 shadow-lg" />
            </article>
            <article className="shadow-md rounded-lg overflow-hidden flex-shrink-0">
              <img
                src={bootstrap}
            ...
            <article className="shadow-md rounded-lg overflow-hidden flex-shrink-0">
              <img src={firebase} alt="Anime" className="w-32 h-32 shadow-lg" />
            </article>
            <article className="shadow-md rounded-lg overflow-hidden flex-shrink-0">
