              ...
              <Card className="w-full max-w-[26rem] shadow-lg">
                ...
                <CardBody>
                  ...
                  <Typography color="gray">
                    Rosati Pharmacy is a website created for the final project
                    of a software engineering course. This website was created
                    with Laravel and Bootstrap then deployed with Digital Ocean
                  </Typography>
              ...
              <Card className="w-full max-w-[26rem] shadow-lg">
                ...
                <CardBody>
                  ...
                  <Typography color="gray">
                    ...
                    which is required by several criteria. I created this
                    website with ReactJS + Vite with bootstrap styling. It
                    contains CRUD to add products and is also integrated with
                    OpenAi
                  </Typography>
